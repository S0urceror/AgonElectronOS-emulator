pub mod keymap {
    ...
    pub fn sdl_scancode_to_fbgl_virtual_key(scancode: Scancode, keymod: Mod) -> FabGlVirtualKey {
        ...
        match scancode {
            ...
            Scancode::A => if shift {FabGlVirtualKey::VK_A} else {FabGlVirtualKey::VK_a},
            Scancode::B => if shift {FabGlVirtualKey::VK_B} else {FabGlVirtualKey::VK_b},
            Scancode::C => if shift {FabGlVirtualKey::VK_C} else {FabGlVirtualKey::VK_c},
            Scancode::D => if shift {FabGlVirtualKey::VK_D} else {FabGlVirtualKey::VK_d},
            Scancode::E => if shift {FabGlVirtualKey::VK_E} else {FabGlVirtualKey::VK_e},
            Scancode::F => if shift {FabGlVirtualKey::VK_F} else {FabGlVirtualKey::VK_f},
            Scancode::G => if shift {FabGlVirtualKey::VK_G} else {FabGlVirtualKey::VK_g},
            Scancode::H => if shift {FabGlVirtualKey::VK_H} else {FabGlVirtualKey::VK_h},
            Scancode::I => if shift {FabGlVirtualKey::VK_I} else {FabGlVirtualKey::VK_i},
            Scancode::J => if shift {FabGlVirtualKey::VK_J} else {FabGlVirtualKey::VK_j},
            Scancode::K => if shift {FabGlVirtualKey::VK_K} else {FabGlVirtualKey::VK_k},
            Scancode::L => if shift {FabGlVirtualKey::VK_L} else {FabGlVirtualKey::VK_l},
            Scancode::M => if shift {FabGlVirtualKey::VK_M} else {FabGlVirtualKey::VK_m},
            Scancode::N => if shift {FabGlVirtualKey::VK_N} else {FabGlVirtualKey::VK_n},
            Scancode::O => if shift {FabGlVirtualKey::VK_O} else {FabGlVirtualKey::VK_o},
            Scancode::P => if shift {FabGlVirtualKey::VK_P} else {FabGlVirtualKey::VK_p},
            Scancode::Q => if shift {FabGlVirtualKey::VK_Q} else {FabGlVirtualKey::VK_q},
            Scancode::R => if shift {FabGlVirtualKey::VK_R} else {FabGlVirtualKey::VK_r},
            Scancode::S => if shift {FabGlVirtualKey::VK_S} else {FabGlVirtualKey::VK_s},
            Scancode::T => if shift {FabGlVirtualKey::VK_T} else {FabGlVirtualKey::VK_t},
            Scancode::U => if shift {FabGlVirtualKey::VK_U} else {FabGlVirtualKey::VK_u},
            Scancode::V => if shift {FabGlVirtualKey::VK_V} else {FabGlVirtualKey::VK_v},
            Scancode::W => if shift {FabGlVirtualKey::VK_W} else {FabGlVirtualKey::VK_w},
            Scancode::X => if shift {FabGlVirtualKey::VK_X} else {FabGlVirtualKey::VK_x},
            Scancode::Y => if shift {FabGlVirtualKey::VK_Y} else {FabGlVirtualKey::VK_y},
            Scancode::Z => if shift {FabGlVirtualKey::VK_Z} else {FabGlVirtualKey::VK_z},
